...
MODE 90, 25
(CHCP 65001)>NUL
SET "d[tex]=Path ComSpec TEMP SystemRoot d[tex]"
...
%music:t s=Music title%&%music:t s=Music rain%
...
IF %d[num]% EQU 4 (
    ...
    FOR /F "tokens=1-2 delims=;" %%Q in ("%d[num]%;!char[%d[num]%]!") DO (
        FOR /F "tokens=2-4,7-8 delims=$" %%A in ("!char[%%R]!") DO (
            SET /A "d[texnum]=d[erase]","d[erase]=((%%Q-1)*7)+4","d[error]=%%Q"
            ECHO %ESC%[!d[texnum]!;61H %dn:n=1%%bk:n=1%  %dn:n=1%%bk:n=2%  %dn:n=1%%bk:n=2% %col:c=70;175;227%%ESC%[!d[erase]!;61H┐%dn:n=1%%bk:n=1%╫╕%dn:n=1%%bk:n=2%╫╛%dn:n=1%%bk:n=2%┘%ESC%[5;75H%col:c=160;198;219%%%R    %col:c=199;42;175%%ESC%[7;64HChakra : %col:c=160;198;219%%%A %col:c=199;42;175%%ESC%[8;64HSpirit : %col:c=160;198;219%%%B %col:c=199;42;175%%ESC%[9;64HJump : %col:c=160;198;219%%%C %col:c=199;42;175%%ESC%[10;64HAttunement : %col:c=160;198;219%%%D %col:c=199;42;175%%ESC%[11;64HSpecial : %col:c=160;198;219%%%E     
        )
    )
)
GOTO :SELECTCHAR
...
IF defined char[level] (
    ...
    %music:t s=Music level%
    CALL :LEVEL%char[level]%
) else (
    IF defined char[done] (
        %music:t s=Music sanctuary%
        SET "lev[chap]=SANCTUARY"
        CALL :SANCTUARY
    ) else (
        %music:t s=Music prologue%&%music:t s=Music rain%
